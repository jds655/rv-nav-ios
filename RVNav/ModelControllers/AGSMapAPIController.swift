...
//class AGSMapAPIController: MapAPIControllerProtocol, AGSGeoViewTouchDelegate {
//
//    // MARK: - Properties
...
//        private func createBarriers(from route: RouteInfo, with vehicle: Vehicle) -> [AGSPolygonBarrier]{
//        let const = 0.0001
...
//        }
//        
//        guard let vehicleHeight = vehicle.height else { return [] }
//        
//
//        let routeInfo = RouteInfo(height: vehicleHeight, startLon: route.startLon, startLat: route.startLat, endLon: route.endLon, endLat: route.endLat)
//
//        avoidanceController.getAvoidances(with: routeInfo) { (avoidances, error) in
//            if let error = error {
//                NSLog("error fetching avoidances \(error)")
...
//                print("Barrier count: \(tempBarriers.count)")
//            }
//        }
//        return barriers
//    }
